<?php
$my_name = 'Иннокентий'; // строка
$my_profession = `web-programmist`// строка
...
<p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $my_profession; ?></p>

...
$profi = 'Программист'; // строка
$email = 'email@email.com'; // строка
$phone = 89038639253; // десятичное число
$age = 2022-1985;
$days = (2022-1985)*365;
$skills = [
...
$work_expirience = [
    ...
    'time_of_work' => ['Jan 2015', 'Mar 2012 - Dec 2014', 'Jun 2010 - Mar 2012'],
...
<div class="w3-container">
<h5 class="w3-opacity"><b><?php echo $work_expirience['post'][0];?></b></h5>
<h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work_expirience['time_of_work'][0];?> - <span class="w3-tag w3-teal w3-round">Current</span></h6>
<p><?php echo $work_expirience['description'][0];?></p>
<hr>
</div>
<div class="w3-container">
<h5 class="w3-opacity"><b><?php echo $work_expirience['post'][1];?></b></h5>
<h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work_expirience['time_of_work'][1];?></h6>
<p><?php echo $work_expirience['description'][1];?></p>
<hr>
</div>
<div class="w3-container">
<h5 class="w3-opacity"><b><?php echo $work_expirience['post'][2];?></b></h5>
<h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work_expirience['time_of_work'][2];?></h6>
<p><?php echo $work_expirience['description'][2];?> </p><br>
</div>
</div>
